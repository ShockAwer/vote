...
<FONT size="-1">[<A href="#make">新規箱作成＿</A>][<A href="http://www.zianplus.net">インデックス</A>][<A href="http://www.zianplus.net/mail.htm">管理人宛</A>][<A href="http://www.zianplus.net/cgi-bin/php/zianchat.cgi">チャット</A>][<A href="http://www.zianplus.net/cgi-bin/vote-/list.cgi">自動アンケート-</A>][<A href="http://www.zianplus.net/guideline.txt">利用規約</A>]</FONT><FONT size="-1">[<A href="http://d.hatena.ne.jp/natori/">#A1FE9F</A>][<A href="http://ee.uuhp.com/~shi946/">点取り</A>][<A href="http://www.zianplus.net/cgi-bin/e/bbsnote.cgi">お絵かき</A>]</FONT>
<FORM method="GET" ACTION="./$cginame1"><FONT size="-1"><INPUT TYPE=text NAME="lm" SIZE="3" VALUE="$lmax"> 件表\示 <INPUT TYPE=text NAME="h" SIZE="3" VALUE="0">日以内に更新した箱</FONT><FONT size="-1"><input type="radio" name="r" value="0" checked>作成順<input type="radio" name="r" value="1" >投票順<input type="radio" name="r" value="2" >票数順</FONT>
<FONT size="-1"><input type="checkbox" name="chg" value="on">内容文表\示　</FONT><FONT size="-1"><INPUT type="submit" value="設定"></FONT></FORM>
<UL>
<li>${date}現在の投票箱のリスト
<li>日付、時刻は最終書き込み時です。
<li>先頭の◇をクリックすると新たなプラウザを開く予\定。
_HTML_
	&listing;#リスト作成
if($test >= $forbid){
print <<"_HTML_";
</UL>
箱数上限\に達しましたので新規の話題を投稿できません。
<p>
<HR>
...
<INPUT type=submit value="これでいいです。"><FONT size="-1" COLOR="red"> <A href="http://www.zianplus.net/guideline.txt">利用規約</A>を読み、規約に完全に同意してから送信してください。</FONT>
